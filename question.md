...
\operatorname{erf}(x)=\frac{\left(\left(\left(\left(0.053443748819 x^{2}+0.75517016694 e 1\right) x^{2}+0.10162808918 e 3\right) x^{2}+0.13938061484 e 4\right) x^{2}+0.50637915060 e 4\right) x^{2}+0.2963838468 e 5) x}{\left(\left(\left(\left(x^{2}+0.31212858877 e 2\right) x^{2}+0.39856963806 e 3\right) x^{2}+0.30231248150 e 4\right) x^{2}+0.13243365831 e 5\right) x^{2}+0.2667224157 e 5}
